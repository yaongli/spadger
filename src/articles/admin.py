...
from articles.models import Author, Article, Category, Carousel, Nav, Column, News, Book, Chapter
...
class ChapterAdmin(admin.ModelAdmin):
    search_fields = ('book', 'title', 'summary')
    list_filter = ('book', 'status', 'create_time', 'update_time')
    list_display = ('book', 'title', 'status', 'update_time')
    fieldsets = (
        (u'基本信息', {
            'fields': ('book', 'title', 'en_title', 'img', 'tags', 'rank', 'status')
        }),
        (u'摘要', {
            'fields': ('summary',)
        }),
